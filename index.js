...
if (trueSelection(state, "* go for any one option")) {
if (textAlphanumeric(addr, "* please use numbers and letters *")) {
...
document.getElementById('p2').innerText = "* Only " + min + " and " + max + " characters *"; // This segment displays the validation rule for username
inputtext.focus();
return false;
}
}
